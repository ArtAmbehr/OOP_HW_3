...
public class Program{
    public static void main(String[] args) {
        ...
        FiguresCollection all = new FiguresCollection ();
    ...
    public static ArrayList<Figures> getArrayB() {
        return FiguresCollection.allFigure;
    }
    ...
    public static void programMenu(Scanner input, ArrayList<Figures> allFigure) {
        ...
        System.out.println("4. Вывод информации о всех периметрах, площадях и длине окружности всех фигур, где это возможно");
        ...
        switch (choise) {
            ...
            case 3:
                ...
                programMenu(input, allFigure);
            case 4:
                FiguresCollection.getAllParameters();
                programMenu(input, allFigure);
            case 5:
                FiguresCollection.deleteFigure(input, allFigure);
                programMenu(input, allFigure);
            case 6:
                FiguresCollection.editFigure(input, allFigure);
                programMenu(input, allFigure);
            case 7:
